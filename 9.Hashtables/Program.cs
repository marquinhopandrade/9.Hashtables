...
namespace _9.Hashtables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //serve para acessar o id 1 da hash table, porém só funciona pq foi especifica em (Student) que o studentsTable[1] era do tipo objeto (Retrieve individual item with known ID)
